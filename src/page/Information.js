      ...
      <Box sx={{ width: "100%", pr: 5 }}>
        ...
        <Box sx={{ pb: 6, pt: 2, maxWidth: 1440, mx: "auto" }}>
          ...
          <Stack direction="row" flexWrap="wrap" gap={2} mb={3} sx={{ animation: "fadeUp 0.4s ease both" }}>
            <KpiCard icon={<PaidIcon sx={{ fontSize: 18 }} />} label="Omzet Bulan Ini" value={fmtShort(currentMonthOmzet)} sub={`vs ${fmtShort(prevMonthOmzet)} bulan lalu`} trend={omzetTrend} color={C.primary} soft={C.primarySoft} />
            <KpiCard icon={<BarChartIcon sx={{ fontSize: 18 }} />} label="Total Omzet 12 Bln Terakhir" value={fmtShort(total12)} sub={rangeLabel12} color={C.secondary} soft={C.secondarySoft} />
