  ...
  return (
    <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", width: "100%", height: "100vh" }}>
      <Box sx={{ width: "70%", height: "70%", backgroundColor: "#E06F2C", borderRadius: "24px", boxShadow: "0px 0px 48px -32px rgba(0,0,0,0.75)", display: "flex" }}>
        ...
        <Box sx={{ width: "35%", height: "100%", backgroundColor: "#FFFFFF", borderRadius: "0 24px 24px 0" }}>
          <Box sx={{ width: "100%", display: "flex", justifyContent: "center", mt: 16 }}>
            <Typography sx={{ fontFamily: "poppins", fontSize: "44px", fontWeight: "400" }}>Login</Typography>
          </Box>
